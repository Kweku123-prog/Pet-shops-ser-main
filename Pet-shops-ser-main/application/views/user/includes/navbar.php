                ...
                <ul class="nav header-navbar-rht">
                    ...
                    if ($this->session->userdata('id') != '') {
                        ...
                        if ($this->session->userdata('usertype') == 'provider') {
                            ...
                            <li class="nav-item desc-list wallet-menu">
                                <a href="<?php echo base_url(); ?>add-product"class="nav-link header-login">
                    ...
                    if (($this->session->userdata('id') != '') && ($this->session->userdata('usertype') == 'provider')) {
                        ...
                        if (!empty($get_availability) && !empty($get_subscriptions['id']) && $check_avail > 5) {
                            ...
                            <li class="nav-item desc-list">
                            <a href="<?php echo base_url(); ?>add-product"   class="nav-link header-login">Add Product</a>
                            ...
                            <li class="nav-item desc-list">
                            <a href="<?php echo base_url(); ?>add-product" class="nav-link header-login get_pro_subscription">Add Product</a>
                            ...
                            <li class="nav-item desc-list">
                            <a href="<?php echo base_url(); ?>add-product"  class="nav-link header-login get_pro_availabilty">Add Product</a>
